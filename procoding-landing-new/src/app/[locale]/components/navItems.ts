export const schoolSections = [
    { key: "nav.about", href: "#about2" },
    { key: "nav.courses", href: "#courses" },
    { key: "nav.instructors", href: "#instructors" },
    // { key: "nav.reviews", href: "#reviews" },
    { key: "nav.contact", href: "#contact" },
    { key: "nav.faq", href: "#faq_school" },
    { key: 'nav.about', href: '#about2', icon: '/images/about_cup_icon.svg' },
    { key: 'nav.courses', href: '#courses', icon: '/images/icons/curriculum.svg' },
...
export const courseNavItems = [
    ...
    { key: 'nav.instructors', href: '#instructors', icon: '/images/icons/menu_people.svg' },
    { key: "nav.jobs", href: "#jobs", icon: '/images/icons/menu_people.svg' },
